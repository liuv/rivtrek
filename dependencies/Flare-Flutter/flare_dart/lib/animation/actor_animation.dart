...
class ComponentAnimation {
  ...
  static ComponentAnimation read(
    ...
    componentAnimation._properties = <PropertyAnimation>[];
    for (int i = 0; i < numProperties; i++) {
      PropertyAnimation? prop = PropertyAnimation.read(
          reader, components[componentAnimation._componentIndex]!);
      if (prop != null) {
        componentAnimation._properties.add(prop);
      }
    }
    reader.closeObject();
...
class ActorAnimation {
          ...
          case PropertyTypes.Trigger:
            ...
            if (idx == 0) {
              if (kfl > 0 && keyFrames[0].time == toTime) {
                ...
                if (component != null) {
                  triggerEvents.add(AnimationEventArgs(component.name,
                      component, property.propertyType, toTime, 0.0));
                }
              }
            } else {
  ...
  static ActorAnimation read(
    ...
    animation._components = <ComponentAnimation>[];
    animation._triggerComponents = <ComponentAnimation>[];
