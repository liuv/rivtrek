...
class TimelineEntryWidget extends LeafRenderObjectWidget {
  ...
  TimelineEntryWidget(
      {Key? key, required this.isActive, required this.timelineEntry, this.interactOffset = const Offset(0,0)})
      : super(key: key);
...
class VignetteRenderObject extends RenderBox {
  ...
  updateActor() {
    if (_timelineEntry == null) {
      ...
      TimelineAsset asset = _timelineEntry?.asset?? TimelineAsset();
  ...
  TimelineEntry get timelineEntry => _timelineEntry?? TimelineEntry();
    ...
    if (_timelineEntry != null) {
      ...
      if (asset is TimelineNima && _nimaActor != null) {
        ...
        if (asset.idleAnimations != null) {
          ...
          if (asset.intro == asset.animation &&
              asset.animationTime >= asset.animation!.instance!.animation.endTime) {
            asset.animationTime -= asset.animation!.instance!.animation.endTime;
            asset.animation = asset.idle;
          }
