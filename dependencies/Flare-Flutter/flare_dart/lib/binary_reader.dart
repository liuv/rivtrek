...
abstract class BinaryReader implements StreamReader {
  ...
  @override
  int readVersion() {
    return readUint32("version");
  }

  @override
  int readUint8Length() {
    return readUint8("length");
  }
